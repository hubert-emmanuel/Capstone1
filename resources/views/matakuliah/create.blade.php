                            ...
                            <div class="card-body">
                                ...
                                @endif
                                    @if(Auth::user()->role == 'prodi')
                                        <form method="post" action="{{ route('matakuliah-store-prodi') }}" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    @if(Auth::user()->role == 'mahasiswa')
                                        <form method="post" action="{{ route('matakuliah-store-mahasiswa') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class ="form-group">
                                                <label for="id-mk">ID Mata Kuliah</label>
                                                <input type="text" class="form-control" id="id-mk"
